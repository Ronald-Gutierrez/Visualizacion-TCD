...
if aqi_data.empty or meo_data.empty or knn_data.empty:
    ...
    for _, row in knn_data.iterrows():
        ...
        if not combined_data.empty:
            ...
            pca_df['date'] = combined_data['date'].values
            pca_df['time'] = combined_data['time'].values
    ...
    if pca_results:
        ...
        final_pca_df.to_csv('data/data_pca_real_SIN-DW.csv', index=False)

        print("Archivo PCA guardado como 'data/data_pca_real_GAAAAA.csv'")
    else:
