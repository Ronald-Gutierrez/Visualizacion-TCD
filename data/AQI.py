...
data = pd.read_csv('beijing_17_18_aq.csv')
...
station_data['AQI'] = station_data[[f'IAQI_{pollutant}' for pollutant in ['PM2.5', 'PM10', 'SO2', 'NO2', 'CO', 'O3']]].max(axis=1)
...
daily_aqi.to_csv('aqi.csv', index=False)
